...
- どの階層にいても`qq`で終了するようにしたい 2014/06/03
- ランダム設定のときに日英混在で出てくるようにしたい 2014/06/03
- 実行時に書き込み（単語の新規登録）もできるようにしたい 2014/06/03
- ブラウザで実行できるようにしたい（Webアプリ化） 2014/06/04
- 実行（レッスン）した内容を記録・保管しておけるようにしたい 2014/06/04
  - データベース必須か
- 正答したら得点が加算されるようにしたい 2014/06/04
  - プログラム終了するたびにリセット＆記録保管とか
- スマホから実行できるようにしたい（モバイルアプリ化） 2014/06/04
